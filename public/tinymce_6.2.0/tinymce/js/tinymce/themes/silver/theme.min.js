...
!(function () {
  ...
  const ey = (e, t) => {
    ...
    ky = (e, t) => {
      ...
      if (t.length > 0) {
        ...
        return o.replace(
          e,
          (e) => `<span className="tox-autocompleter-highlight">${e}</span>`
        );
      }
      return o;
    },
                    ...
                    ((o, n) => {
                      const s = P(n, (o) => {
                          const n = Ah.translate(o.text),
                            s =
                              1 === e.columns
                                ? `<div className="tox-collection__item-label">${n}</div>`
                                : "",
                            r = `<div className="tox-collection__item-icon">${o.icon}</div>`,
                            a = { _: " ", " - ": " ", "-": " " },
                            i = n.replace(/\_| \- |\-/g, (e) => a[e]);
                          return `<div className="tox-collection__item${
                            t.isDisabled()
                        ...
                        a = P(
                          r,
                          (e) =>
                            `<div className="tox-collection__group">${e.join(
                              ""
                            )}</div>`
                        );
                      $r(o.element, a.join(""));
              ...
              rE.block(
                ...
                ((e) => (t, o) => ({
                  ...
                  components: [
                    {
                      dom: aE(
                        '<div className="tox-spinner"><div></div><div></div><div></div></div>'
                      ),
                    },
                  ],
                }))(n)
  ...
  const ZA = (e, t, o) => {
            ...
            { uiMothership: a, sink: c } = (() => {
              const t = Uf(e),
                ...
                r = {
                  ...
                  behaviours: gl([
                    ud.config({ useFixed: () => n.isDocked(m) }),
                  ]),
                },
                a = {
    ...
    fI = () => ({ dom: aE('<div className="tox-dialog__draghandle"></div>') }),
    bI = (e, t, o) =>
      ((e, t, o) => {
        ...
        return fw.sketch({
          dom: aE('<div className="tox-dialog__header"></div>'),
          components: a,
        });
      })(
        {
    ...
    _I = (e, t, o) => ({
      dom: aE('<div className="tox-dialog__footer"></div>'),
      components: [],
      behaviours: gl([
        DM.config({
          channel: `${nI}-${t}`,
